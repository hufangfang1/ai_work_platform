...
for ratio in [.65,.85,1.2]:
 out=ROOT/'artifacts/sfm'/f'focal-{ratio}';out.mkdir(exist_ok=True)
 ...
 options.mapper.init_min_tri_angle=8;options.mapper.init_min_num_inliers=60
 ...
 summary={'run':out.name,'assumed_focal_ratio':ratio,'init_min_tri_angle':8,'init_min_num_inliers':60,'models':result}
